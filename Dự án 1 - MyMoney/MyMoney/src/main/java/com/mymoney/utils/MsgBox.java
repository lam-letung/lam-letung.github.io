...
public class MsgBox {
    ...
    */
     ...
     * @param return là kết quả nhận được true/ false
     */
     ...
     *  @param return là kết quả nhập từ người dùng nhập vào
     */
    public static  String promp(Component parent , String message){
