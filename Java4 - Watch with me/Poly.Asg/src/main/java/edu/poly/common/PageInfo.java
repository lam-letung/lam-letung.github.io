...
//	pageRoute định nghĩa các danh sách sẽ thực hiện include vào trang layout.jsp
	public static Map<PageType, PageInfo> pageRoute = new HashedMap();
	
//	Sử dụng khối tĩnh để khởi tạo cho pageRoute
	static {
		...
		pageRoute.put(PageType.SITE_FAVORITE_PAGE, new PageInfo("Favorites", "/sites/users/favorite.jsp", null));
...
//	Cho phép chuyển nội dung tới cho trang layout , kèm theo phần page sẽ include vào trang layout.jsp
